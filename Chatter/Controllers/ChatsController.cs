...
namespace Chatter.Controllers
{
    public class ChatsController : Controller
    {
        ...
        public JsonResult TestJson()
        {
            ...
            //            SELECT ChatID, UserName, Message, Date
            //FROM Chat
            ...
            var chats = from Chats in db.Chats
                        join AspNetUsers in db.AspNetUsers on new { UserID = Chats.UserID } equals new { UserID = AspNetUsers.Id }
                        orderby
                        Chats.Date descending
                        select new
                        {
        ...
        public ActionResult Create([Bind(Include = "ChatID,UserID,Message,Date")] Chat chat)
        {
            if (ModelState.IsValid)
            {
                db.Chats.Add(chat);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ChatID,UserID,Message,Date")] Chat chat)
        {
            if (ModelState.IsValid)
            {
